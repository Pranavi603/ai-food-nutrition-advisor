...
@app.get("/food")
def food(request: Request, weight: float, height: float):
    ...
    if bmi < 18.5:
        calorie_advice = "Increase calorie intake."
    elif bmi < 25:
        calorie_advice = "Maintain your calorie intake."
    elif bmi < 30:
        calorie_advice = "Reduce calorie intake slightly."
    else:
        calorie_advice = "Significantly reduce calorie intake."
